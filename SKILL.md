...
- **成熟节点**（28nm 及以上）：仅华虹/晶合等特色工艺（BCD/IGBT/SiC/GaN）按需追踪，不作为报告主体
...
**Agent E — 专利搜索**（新增）
```
搜索最新半导体相关专利，优先使用 agent-browser 访问各专利数据库，失败时降级使用 WebFetch。
...
9. **中国半导体行业协会 / 芯思想 / 芯智讯**（SMIC 制程状态/良率/产能/国产设备突破）
10. **半导体行业观察 / 集微网**（国产 EDA/设备/材料进展、出口管制影响）
11. **SCMP / 南华早报**（中国半导体产业动态）
12. **大半导体产业网 / 摩尔精英**（SMIC N+2/N+3 相关报道、PDK 状态追踪）
